    ...
    build: {
      rollupOptions: {
        input: {
          ...
          admin_tours: path.resolve(__dirname, 'admin/tours.html'),
          admin_designs: path.resolve(__dirname, 'admin/designs.html'),
          admin_gallery: path.resolve(__dirname, 'admin/gallery.html'),
          admin_reviews: path.resolve(__dirname, 'admin/reviews.html'),
          admin_messages: path.resolve(__dirname, 'admin/messages.html'),
          admin_staff: path.resolve(__dirname, 'admin/staff.html'),
